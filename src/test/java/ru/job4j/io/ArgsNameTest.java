...
class ArgsNameTest {
    ...
    @Test
    public void whenKeyIsMissingThenExceptionThrown() {
    ...
    @Test
    public void whenValueIsMissingThenExceptionThrown() {
    ...
    @Test
    public void whenColonInsteadOfEqualSignThenExceptionThrown() {
    ...
    @Test
    public void whenMissingDashThenExceptionThrown() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"key=value"}))
                .isInstanceOf(IllegalArgumentException.class)
